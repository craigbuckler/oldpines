...
module.exports = (() => {
  ...
  // replace shortcodes
  let
    scRep = ['name', 'version', 'nowYear', 'url', 'root', 'rootURL', 'menu', 'dateFormatted', 'imagecdn', 'book', 'voucher', 'vouchertext', 'twitter'],
    scFind = scRep.map(
  ...
  const sRep = [
    ...
    { search: '\\s+data-youtube="([^"]+)"\\s*>', replace: ' class="video"><iframe src="https://www.youtube.com/embed/$1" title="video" allow="accelerometer;autoplay;encrypted-media;gyroscope;picture-in-picture" allowfullscreen></iframe>'}
  ];
